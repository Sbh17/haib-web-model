...
-- Update salon descriptions to focus on women's beauty
UPDATE public.salons 
SET description = 'Premier destination for women\'s beauty treatments including hair, makeup, and skincare'
WHERE name = 'Elegant Beauty Spa';

UPDATE public.salons 
SET description = 'Specialized women\'s hair salon offering cutting, coloring, and styling services'
WHERE name = 'Modern Hair Studio';

UPDATE public.salons 
SET description = 'Luxury spa focused on women\'s wellness, skincare, and nail treatments'
